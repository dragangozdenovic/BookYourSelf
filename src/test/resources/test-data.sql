...
values ('user2', 'svarli1@gmail.com', '$2a$10$uT0lZ2AQG2qNEVZn5zQfP.tng7Di09OEH4OwHK4bx4gdpYSqLQds2', 'Nenad', 'Marković', 'kraljevo', '069-5257008', true, true,2);
...
insert into jdbc.avio_prices (name, price, avio_company, version) values ('Luggage <= 5kg', 50, 3, 0);
insert into jdbc.avio_prices (name, price, avio_company, version) values ('Luggage <= 10kg', 100, 3, 0);
insert into jdbc.avio_prices (name, price, avio_company, version) values ('Luggage <= 20kg', 150, 3, 0);
...
insert into jdbc.room (name, number_of_room,reserved,hotel_id,date_in,date_out,price,number_bed,number_floor)
value ('jednokrevetna','25',true,1,'2014-05-07','2014-05-08 ',25,1,1);
insert into jdbc.room (name, number_of_room,reserved,hotel_id,date_in,date_out,price,number_bed,number_floor)
value ('dvokrevetna','3',false,2,'2019-01-26','2019-01-30',50,2,2);
insert into jdbc.room (name, number_of_room,reserved,hotel_id,date_in,date_out,price,number_bed,number_floor)
value ('trokrevetna','202',false,1,'2018-01-31 ','2018-02-05',100,3,2);
insert into jdbc.room (name, number_of_room,reserved,hotel_id,date_in,date_out,price,discount_price,number_bed,number_floor)
value ('trokrevetna','201',false,1,'2018-01-31 ','2018-02-01',75,65,3,4);

insert into jdbc.service(name,price)
values ('wifi',50);
insert into jdbc.service(name,price)
values ('Swimming pool',100);
insert into jdbc.service(name,price)
values ('breakfast',25);
...
insert into jdbc.flight(arrival_time, departure_time, flight_time, ticket_price, company, destination)
values ('2018-01-25 11:00','2018-01-31 12:00',1.5,150,3,1);

insert into jdbc.flight(arrival_time, departure_time, flight_time, ticket_price, company, destination)
values ('2018-05-15 12:00','2018-06-21 15:00',1.5,100,2,2);

insert into jdbc.flight(arrival_time, departure_time, flight_time, ticket_price, company, destination)
values ('2018-05-15 12:00','2018-06-21 15:00',1.5,100,1,1);
